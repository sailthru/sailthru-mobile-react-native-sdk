...
class RNMessageStreamModuleTest {
    ...
    fun testGetMessage() {
        ...
        // Initiate test
        rnMessageStreamModuleSpy.getMessage(messageId, promise)
    ...
    fun testRemoveMessage() {
        ...
        val message: Message = mock()
        val moduleSpy = Mockito.spy(rnMessageStreamModule)
        doReturn(message).whenever(moduleSpy).createMessage(readableMap, promise)
    ...
    fun testRemoveMessageException() {
        ...
        val moduleSpy = Mockito.spy(rnMessageStreamModule)
        doThrow(jsonException).whenever(moduleSpy).createMessage(readableMap, promise)
    ...
    fun testRegisterMessageImpression() {
        ...
        val readableMap: ReadableMap = mock()
        val message: Message = mock()
        doReturn(message).whenever(rnMessageStreamModuleSpy).createMessage(readableMap, null)
    ...
    fun testRegisterMessageImpressionException() {
        ...
        val readableMap: ReadableMap = mock()
        val jsonException: JSONException = mock()
        doThrow(jsonException).whenever(rnMessageStreamModuleSpy).createMessage(readableMap, null)
    ...
    fun testCreateMessage() {
        ...
        // Initiate test
        val message = rnMessageStreamModuleSpy.createMessage(readableMap, promise)
